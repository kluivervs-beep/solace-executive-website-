(() => {
  ...
  const dict = {
    nl: {
      ...
      'dash.concierge.preview': 'Voorbeeld',
      'dash.concierge.msg1': 'Goedemiddag. Waarmee kan ik u vandaag helpen?',
      'dash.concierge.msg2': 'Ik heb vrijdag een chauffeur nodig in Londen, rond 18:00.',
      'dash.concierge.msg3': 'Genoteerd. Ik geef dit door aan het team voor beoordeling en u hoort binnen enkele uren van ons.',
      'dash.concierge.placeholder': 'Typ een bericht&hellip;',
    ...
    en: {
      ...
      'dash.concierge.panel': 'AI concierge',
      'dash.concierge.preview': 'Preview',
      'dash.concierge.msg1': 'Good afternoon. How can I help you today?',
      'dash.concierge.msg2': 'I need a driver in London on Friday, around 6pm.',
      'dash.concierge.msg3': 'Noted. I am passing this on to the team for review and you will hear from us within a few hours.',
      'dash.concierge.placeholder': 'Type a message&hellip;',
