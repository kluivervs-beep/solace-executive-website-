(() => {
  ...
  const dict = {
    nl: {
      ...
      'form.note': 'Dit formulier is momenteel niet gekoppeld aan een backend/e-mailservice. Sluit een provider (bijv. Formspree, e-mail-API) aan om aanvragen echt te ontvangen.',
    ...
    en: {
      ...
      'form.note': 'This form is not yet connected to a backend/email service. Connect a provider (e.g. Formspree, an email API) to actually receive submissions.',
