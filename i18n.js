(() => {
  ...
  const dict = {
    nl: {
      ...
      'dash.concierge.locked.body': 'De AI Concierge is een voordeel van uw lidmaatschap. Neem contact op om uw lidmaatschap te activeren.',
      'dash.concierge.locked.cta': 'Activeer via WhatsApp',
    ...
    en: {
      ...
      'dash.concierge.locked.body': 'The AI Concierge is a membership benefit. Get in touch to activate your membership.',
      'dash.concierge.locked.cta': 'Activate via WhatsApp',
