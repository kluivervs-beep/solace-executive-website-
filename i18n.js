(() => {
  ...
  const dict = {
    nl: {
      ...
      'jetslp.title': 'Private Jets.',
      'jetslp.sub': 'Charter op korte termijn. Wereldwijde toegang tot vlootpartners, cabine ingericht naar wens.',
      'jetslp.cta': 'Word lid',
      'jetslp.hint': 'Wij beoordelen elke aanvraag persoonlijk. Reactie doorgaans binnen 24 uur.',
    ...
    en: {
      ...
      'jetslp.title': 'Private Jets.',
      'jetslp.sub': 'Charter at short notice. Worldwide access to fleet partners, cabin arranged to your preference.',
      'jetslp.cta': 'Become a member',
      'jetslp.hint': 'We review every application personally. Response usually within 24 hours.',
