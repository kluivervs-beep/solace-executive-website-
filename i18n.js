(() => {
  ...
  const dict = {
    nl: {
      ...
      'service.lifestyle': 'Fleet & Lifestyle',
      ...
      'service.lifestyle.desc': "Supercars en executive SUV's door heel Europa, plus personal shopping, styling en VIP-toegang op aanvraag.",
      'service.lifestyle.link': 'Bekijk de vloot →',
    ...
    en: {
      ...
      'service.lifestyle.desc': 'Supercars and executive SUVs delivered across Europe, plus personal shopping, styling and VIP access on request.',
      'service.lifestyle.link': 'View the fleet →',
