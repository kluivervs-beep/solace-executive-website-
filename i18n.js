(() => {
  ...
  const dict = {
    nl: {
      ...
      'dash.concierge.founder.welcome': 'Hey {name}, welkom bij Solace Executive. Ik ben Kluiver, oprichter, en fijn dat je erbij bent. Mijn AI concierge helpt je verder met al je aanvragen, maar mocht er iets zijn, aarzel niet om me altijd rechtstreeks te bereiken.',
    ...
    en: {
      ...
      'dash.concierge.founder.welcome': "Hey {name}, welcome to Solace Executive. I'm Kluiver, founder, and glad to have you here. My AI concierge will help you with all your requests, but if there's ever anything else, feel free to reach me directly at any time.",
