...
const CITIES = [
  ...
  { name: 'London', lat: 51, lon: 0, blurb: 'Kernmarkt · vaste route' },
  { name: 'Paris', lat: 48.85, lon: 2.35, blurb: 'Kernmarkt · vaste route' },
  { name: 'Berlin', lat: 52.52, lon: 13.405, blurb: 'Vlootpartner ter plaatse' },
  { name: 'Vienna', lat: 48.21, lon: 16.37, blurb: 'Vlootpartner ter plaatse' },
  { name: 'Geneva', lat: 46.2, lon: 6.14, blurb: 'Privéjets en jachtcharters' },
  { name: 'Zurich', lat: 47.38, lon: 8.54, blurb: 'Privéjets en jachtcharters' },
  { name: 'Milan', lat: 45.46, lon: 9.19, blurb: 'Vlootpartner ter plaatse' },
  { name: 'Monaco', lat: 43.74, lon: 7.42, blurb: 'Jachtcharters, Middellandse Zee' },
  { name: 'Rome', lat: 41.9, lon: 12.5, blurb: 'Vlootpartner ter plaatse' },
  { name: 'Madrid', lat: 40.42, lon: -3.7, blurb: 'Vlootpartner ter plaatse' },
  { name: 'Barcelona', lat: 41.39, lon: 2.17, blurb: 'Jachtcharters, Middellandse Zee' },
  { name: 'Dubai', lat: 25.2, lon: 55.27, blurb: 'Regionale hub, Midden-Oosten' },
  { name: 'Riyadh', lat: 24.71, lon: 46.68, blurb: 'Regionale hub, Midden-Oosten' },
  { name: 'Doha', lat: 25.29, lon: 51.53, blurb: 'Regionale hub, Midden-Oosten' },
  ...
  { name: 'Los Angeles', lat: 34.05, lon: -118.24, blurb: 'Vlootpartner ter plaatse' },
  { name: 'Sao Paulo', lat: -23.55, lon: -46.63, blurb: 'Regionale hub, Zuid-Amerika' },
  ...
  { name: 'Tokyo', lat: 35.68, lon: 139.65, blurb: 'Regionale hub, Azië-Pacific' },
  { name: 'Shanghai', lat: 31.23, lon: 121.47, blurb: 'Vlootpartner ter plaatse' },
